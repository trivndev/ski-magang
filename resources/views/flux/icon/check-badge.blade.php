...
$classes = Flux::classes('shrink-0')
    ->add(match($variant) {
        ...
        'mini' => '[:where(&)]:size-5',
        'micro' => '[:where(&)]:size-4',
        default => '[:where(&)]:size-6', // Fallback for custom variants like "success", "danger"
    });
// Normalize unknown variants to a safe value for the SVG switch below
$variant = in_array($variant, ['outline','solid','mini','micro']) ? $variant : 'solid';
@endphp
