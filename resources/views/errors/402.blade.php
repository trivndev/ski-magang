...
<main class="w-full max-w-2xl text-center">
    <x-lottie-animation id="error-402" src="{{ asset('lotties/404.lottie') }}" class="w-72 md:w-96 aspect-square mx-auto"/>
    <h1 class="mt-6 text-3xl md:text-4xl font-bold">402 - Payment required</h1>
    <p class="mt-2 text-gray-600">Access to this page requires a payment or an active subscription.</p>
